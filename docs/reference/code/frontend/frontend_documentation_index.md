# Полная документация фронтенда системы управления виртуальной очередью

## Оглавление

1. **[Часть 1: Обзор архитектуры](frontend_documentation_part1_overview.md)**
   - Введение и архитектурная схема
   - Ключевые характеристики обоих интерфейсов
   - Структура директорий
   - Принципы проектирования

2. **[Часть 2: Клиентский интерфейс](frontend_documentation_part2_client_interface.md)**
   - Технологический стек (Vue 3, TypeScript, Pinia)
   - Детальная структура проекта
   - Ключевые компоненты (TicketForm, TicketStatusCard)
   - Управление состоянием (Auth Store, Ticket Store)
   - Композаблы (useApi, useAuth, useTicket)
   - Маршрутизация и рабочий процесс пользователя

3. **[Часть 3: Пользовательский интерфейс](frontend_documentation_part3_user_interface.md)**
   - Технологический стек (Vue 3, JavaScript, Bootstrap Icons)
   - Ролевая модель (Operator, Executor, Admin)
   - Ключевые компоненты (Dashboard, OperatorView, ExecutorView)
   - Управление состоянием (Auth, Operator, Executor Stores)
   - API-клиенты и маршрутизация
...
4. **[Часть 4: Общие подходы и интеграция с API](frontend_documentation_part4_integration_approaches.md)**
   - Управление состоянием (Pinia паттерны)
   - Маршрутизация и защищённые маршруты
   - Работа с API (интерцепторы, обработка ошибок)
   - Аутентификация (Device Fingerprint vs JWT)
   - Стилизация и UI-компоненты
   - Конфигурация окружения и оптимизация
   - Архитектурные диаграммы и рекомендации
...
---
*Документация создана автоматически на основе анализа кодовой базы. Актуально на 2026-05-27.*  
