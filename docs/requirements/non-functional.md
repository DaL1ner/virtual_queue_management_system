...
*Версия: 1.0 | Обновлено: 17.03.2026*
...
| NFR-R-02 | Reliability | Система должна обеспечивать сохранность настроек и истории работы системы при эксплуатации | Высокий | Перезагрузка системы без потери данных |
