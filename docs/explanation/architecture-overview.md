...
Кроме этого, в модели данных предусмотрены сущности для хранения сессий пользователей, справочников, и событий.  
...
Для комплексного описания архитектуры системы на всех уровнях абстракции построена диаграмма в нотации ArchiMate 3.0, которая демонстрирует взаимосвязи между бизнес-уровнем, уровнем приложений и технологическим уровнем.  
  
![Общая диаграмма Archimate 3.0](diagrams/src/archimate/use-case/use-case.png)
