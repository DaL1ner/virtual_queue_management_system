...
## 🎯 Текущий спринт
[Milestone: Sprint 5](https://github.com/DaL1ner/virtual_queue_Project/milestone/5)
...
## 🔹 Цель проекта
Спроектировать полную архитектуру и реализовать MVP веб-приложение для управления виртуальной очередью, обеспечивающее удобную запись, отслеживание статуса и оптимизацию фактического потока клиентов
