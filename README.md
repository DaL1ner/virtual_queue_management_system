...
- [Система управления виртуальной очередьюVirtual Queue Management System](#система-управления-виртуальной-очередьюvirtual-queue-management-system)
  ...
  - [📚 Документация](#-документация)
    ...
    - [Техническая справка](#техническая-справка)
    - [Инструкции по запуску, деплою, миграциям](#инструкции-по-запуску-деплою-миграциям)
    - [Онбординг, первые шаги, примеры сценариев](#онбординг-первые-шаги-примеры-сценариев)
...
### Архитектура
- [Описание архитектуры проекта](docs\explanation\architecture-overview.md)

### Техническая справка
- [Техническая справка](docs\reference)

### Инструкции по запуску, деплою, миграциям
- [Инструкции](docs\howto)

### Онбординг, первые шаги, примеры сценариев
- [Онбординг](docs\reference)
